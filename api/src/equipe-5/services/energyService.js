...
function calcularConsumo(appliances, days = 30) {
    ...
    const items = appliances.map((ap) => {
        ...
        return { name: ap.name, watts: ap.watts, hoursPerDay: ap.hoursPerDay, kwhMes: kwh };
    });
...
function calcularConta(totalKwh, tarifa, bandeira = 'verde') {
...
function simularComparacao(cenarioA, cenarioB, tarifa, bandeira = 'verde') {
...
module.exports = { BANDEIRAS, calcularConsumo, calcularConta, simularComparacao };
