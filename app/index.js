...
// ── Grupo 23 — Autonomia de Carros (Corrigido para evitar bugs) ──
...
// Rotas genéricas das demais equipes (COM A EQUIPE 08 REMOVIDA PARA NÃO DAR CONFLITO)
for (let i = 2; i <= 25; i++) {
  if (i === 6 || i === 7 || i === 8 || i === 9 || i === 13 || i === 14 || i === 16 || i === 17 || i === 18 || i === 20 || i === 21 || i === 23) continue;
