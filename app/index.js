...
// Grupo 5 — Calculadora de Energia
const GRUPO5_PATH = '/grupo5';
const grupo5DistPath = path.join(__dirname, 'grupo5-calculo_energia', 'dist');
...
const equipes = [
  ...
  { numero: 5,  nome: 'Calculadora de Energia',    rota: '/grupo5' },
...
// Rotas genéricas das demais equipes (grupos 5, 6, 13, 14, 16, 17, 18 e 21 têm rotas próprias acima)
for (let i = 2; i <= 25; i++) {
  if (i === 5 || i === 6 || i === 13 || i === 14 || i === 16 || i === 17 || i === 18 || i === 21) continue;
