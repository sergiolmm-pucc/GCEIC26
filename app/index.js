...
const equipes = [
  ...
  { numero: 17, nome: 'Calc NF Venda', rota: '/equipe-17' },
...
app.get('/equipe-17', (req, res) => {
  res.render('nfvenda');
});

app.post('/equipe-17/decodificar', async (req, res) => {
  try {
    const fetch = (await import('node-fetch')).default;
...
app.post('/equipe-17/calcular', async (req, res) => {
  try {
    const fetch = (await import('node-fetch')).default;
