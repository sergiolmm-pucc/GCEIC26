...
async function main() {
  ...
  try {
    ...
    await driver.findElement(By.id('icms')).sendKeys('18');
    await driver.findElement(By.id('ipi')).sendKeys('5');
    await driver.findElement(By.id('pis')).sendKeys('1.65');
    await driver.findElement(By.id('cofins')).sendKeys('7.6');
    ...
    const total = await driver.findElement(By.id('totalNF')).getText();
    console.log('TOTAL:', total);

    if (!total.includes('1322,50')) {
      throw new Error(`Resultado incorreto: ${total}`);
    }
